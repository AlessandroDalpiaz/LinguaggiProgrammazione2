...
public class Salvadanaio extends VBox{
    ...
    public void initialize() {
        getChildren().clear();
        for (int i = 0; i < main.NUM_MONETE; i++) {
            Moneta m= new Moneta();
...
// ============= LISTENER Moneta  ==============================================
    ...
    public class ListenerMonete implements EventHandler {
        ...
        public void handle(Event t) {
            ...
            m.setVisible(false);
            sm.creditBox.incrementValue(main.NPOINTS_PER_MONETA);
            t.consume();
        }
    }

    public class ListenerMoneteWithAnimation implements EventHandler {
