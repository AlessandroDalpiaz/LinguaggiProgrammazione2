...
public class main extends Application {
    ...
    public static final int NUM_SYMBOL_TYPES = 4; // numero di diversi tipi di simbolo 
    public static final int NUM_SYMBOL_COLORS = 2; // numero di diversi tipi di colore 
